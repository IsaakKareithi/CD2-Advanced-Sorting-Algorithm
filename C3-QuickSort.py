...
def partition(A, low, high):
    ...
    #Choosing righmost element as partition
    pivot = A[high]

    #Pointer for greatest elment
    i = low - 1
    ...
    for j in range(low, high):
         if A[j] <= pivot:
           ...
           # Its swapped with the graeter element pointed by i 
           i = i + 1

           #Swapping element at i with element at j 
           (A[i],A[j]) = (A[j],A[i])

    #Swap the pivot element wth the greater element specified by i
